...
- `Agent资源官` 已补齐 `P115StrmHelper` 新版 MoviePilot 兼容补丁脚本，115 健康检查已验证 `p115_ready=true`
- `Agent资源官` 已新增 115 轻量直转层，分享链接落盘可优先不走 `P115StrmHelper.sharetransferhelper`，失败时再回退旧执行层
